...
import time 
elhypamody = '6324982205'
bot = telebot.TeleBot(Config.TG_BOT_TOKEN)
p3 = types.InlineKeyboardMarkup()
p5 = types.InlineKeyboardButton(text = "𝗦𝗢𝗨𝗥𝗖𝗘•𝗦𝗨𝗡𝗗𝗘𝗥𝗟𝗔",url="t.me/SO_Qaid")
...
*لا يمكنك ارسال الروابط*""".format(f2,t2),parse_mode="markdown",disable_web_page_preview=True)
	...
	if m == "المطور" or m == "مطور" or m == "المبرمج":
		p3 = types.InlineKeyboardMarkup()
		e4 = types.InlineKeyboardButton(text = "المطور .",url="t.me/Q_A_ID")
		p3.add(e4)
		h = """[مطور السورس .](t.me/Q_A_ID)"""
...
نوع الحيوان : {}*""".format(f2,t2,r222,d222),disable_web_page_preview=True,parse_mode="markdown")
	if message.text == "السورس" or message.text == "سورس":
	    ...
	    p3 = types.InlineKeyboardMarkup()
	    e3 = types.InlineKeyboardButton(text = "قناة السورس .",url="t.me/SO_Qaid")
	    e4 = types.InlineKeyboardButton(text = "المطور .",url="t.me/Q_A_ID")
	    p3.add(e3,e4)
	    r = random.choice(url)
	    h = """اهلا بك عزيزي في سورس سندرله
[قناة السورس .](t.me/SO_Qaid)
[مطور السورس .](t.me/Q_A_ID)"""
...
""".format(f2,t2),disable_web_page_preview=True,parse_mode="markdown",reply_markup=p3)
	p3 = types.InlineKeyboardMarkup()
	p5 = types.InlineKeyboardButton( "𝗦𝗢𝗨𝗥𝗖𝗘•𝗦𝗨𝗡𝗗𝗘𝗥𝗟𝗔",url="t.me/SO_Qaid")
	p3.add(p5)
...
- - - -- - - - - -- - - - -
CH - @SO_Qaid*""",parse_mode="markdown",reply_to_message_id=message.message_id,reply_markup=p3)
	p3 = types.InlineKeyboardMarkup()
	p5 = types.InlineKeyboardButton( "𝗦𝗢𝗨𝗥𝗖𝗘•𝗦𝗨𝗡𝗗𝗘𝗥𝗟𝗔",url="t.me/SO_Qaid")
	p3.add(p5)
...
- @Sss0s0bot*""",parse_mode="markdown",reply_to_message_id=message.message_id,reply_markup=p3)
	if message.text == "هلو":
	  ...
	  elif message.text =="جيت","انا جيت":
		bot.reply_to(message,"نورت ي غالي 🌚✨❤️‍🔥")
...
▱▰▱▰▱▰▱▰▱▰▱▰▱▰
.*""",reply_markup=p3,parse_mode="markdown")
  p3 = types.InlineKeyboardMarkup()
